...
/**
 * Controller class for managing user accounts and order history
 *
 * This class handles user account-related actions such as updating personal
 * information, changing passwords, and displaying order history. It interacts
 * with the AccountHandler to manage user data and provides methods for
 * populating and initializing the scene.
 *
 * @author Matthew Hay
