...
/**
 * Utility class for validating user registration data
 *
 * This class provides methods for validating various user registration inputs
 * such as names, addresses, postcodes, states, phone numbers, emails, and
 * passwords. It can be used to ensure that user-provided data meets certain
 * criteria before allowing registration.
 *
 * @author Matthew Hay
